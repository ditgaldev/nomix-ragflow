...
export interface OpenApiSchemas {
  ...
  "PageIndexTemplate": {
    ...
    "templateName": string
    "kind": "page_index"
    "entities": Array<OpenApiSchema<"PageIndexEntity">>
    "relations": Array<OpenApiSchema<"PageIndexRelation">>
  }
  "PageIndexResult": {
    "datasetId": string
    "documentId": string
    "templates": Array<OpenApiSchema<"PageIndexTemplate">>
  }
  "PageIndexStatus": {
    "datasetId": string
    "documentId": string
    ...
    "state": "not_configured" | "pending" | "running" | "ready" | "failed" | "cancelled"
    "phase": string | null
  ...
  "PageIndexDocumentTrace": {
    "datasetId": string
    "documentId": string
    "pageIndexAvailable": boolean
    "paths": Array<OpenApiSchema<"PageIndexPath">>
  }
  "PageIndexNavigation": {
    "documents": Array<OpenApiSchema<"PageIndexDocumentTrace">>
  ...
  "PageIndexSearchResult": {
    ...
    "total": number
    "docAggs": OpenApiJsonValue
    "navigation": OpenApiSchema<"PageIndexNavigation">
  }
  "RetrievalChunk": {
    "id"?: string
    "version"?: number
  ...
  "PageIndexGetResponse": {
    "data": OpenApiSchema<"PageIndexResult">
    "meta": OpenApiSchema<"SuccessMeta">
  }
  "PageIndexStatusResponse": {
    "data": OpenApiSchema<"PageIndexStatus">
    "meta": OpenApiSchema<"SuccessMeta">
  }
  "PageIndexBuildResponse": {
    "data": OpenApiSchema<"CommandResult">
    "meta": OpenApiSchema<"SuccessMeta">
  }
  "PageIndexSearchResponse": {
    "data": OpenApiSchema<"PageIndexSearchResult">
    "meta": OpenApiSchema<"SuccessMeta">
  }
...
export interface BusinessGatewayOperationMap {
  ...
  "pageIndex.get": {
    method: "GET"
    path: "/api/v1/datasets/{datasetId}/documents/{documentId}/page-index"
    pathParameters: {
      "datasetId": string
      "documentId": string
    }
    query: Record<string, never>
    body: never
    response: OpenApiSchema<"PageIndexGetResponse">
  }
  "pageIndex.status": {
    method: "GET"
    path: "/api/v1/datasets/{datasetId}/documents/{documentId}/page-index/status"
    pathParameters: {
      "datasetId": string
      "documentId": string
    }
    query: Record<string, never>
    body: never
    response: OpenApiSchema<"PageIndexStatusResponse">
  }
  "pageIndex.build": {
    method: "POST"
    path: "/api/v1/datasets/{datasetId}/documents:build-page-index"
    pathParameters: {
      "datasetId": string
    }
    query: Record<string, never>
  ...
  "documentIds": Array<string>
    ...
    response: OpenApiSchema<"PageIndexBuildResponse">
  }
  "pageIndex.search": {
    method: "POST"
    path: "/api/v1/page-index/retrieval"
    pathParameters: Record<string, never>
    query: Record<string, never>
    body: {
  "datasetIds": Array<string>
  ...
  "limit"?: number
    ...
    response: OpenApiSchema<"PageIndexSearchResponse">
  }
  "datasets.list": {
    method: "GET"
...
export interface BusinessGatewayOperationDataMap {
  ...
  "pageIndex.get": OpenApiSchema<"PageIndexResult">
  "pageIndex.status": OpenApiSchema<"PageIndexStatus">
  "pageIndex.build": OpenApiSchema<"CommandResult">
  "pageIndex.search": OpenApiSchema<"PageIndexSearchResult">
